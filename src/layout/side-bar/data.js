export const sidebarData = [
    {
        id: 1, title: 'Dashboard', path: '/program-organizer', icon: <svg
    ...
    {
        id: 2, title: 'Projects', path: '/program-organizer/projects', icon: <svg
            xmlns='http://www.w3.org/2000/svg'
    ...
    {
        id: 3, title: 'Add Projects', path: '/program-organizer/add-project', icon: <svg
            className='icon icon-tabler icon-tabler-puzzle'
            width={18}
            height={18}
            strokeWidth='1.5'
