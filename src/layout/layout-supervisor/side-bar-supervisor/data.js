export const sidebarDataSupervisor = [
    {
        id: 1, title: 'Dashboard', path: '/supervisor', icon: <svg
    ...
    {
        id: 2, title: 'Projects', path: '/supervisor/projects', icon: <svg
            xmlns='http://www.w3.org/2000/svg'
    ...
    {
        id: 3, title: 'Requests', path: '/supervisor/requests', icon: <svg
            xmlns='http://www.w3.org/2000/svg'
            className='icon icon-tabler icon-tabler-puzzle'
            width={18}
            height={18}
    ...
    {
        id: 3, title: 'Chat', path: '/supervisor/chat', icon: <i className="fa fa-comments-o" aria-hidden="true"></i>
    },
    // {
